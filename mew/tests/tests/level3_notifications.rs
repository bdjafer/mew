...
mod crud {
    ...
    pub fn scenario() -> Scenario {
        Scenario::new("crud")
            ...
            .step("test_cleanup_messages", |a| a.deleted_gte(1))
            .step("test_cleanup_deliveries", |a| a.deleted_gte(0))
            .step("test_cleanup_subscribers", |a| a.deleted_gte(1))
            .step("test_cleanup_groups", |a| a.deleted_gte(1))
            .step("test_cleanup_channels", |a| a.deleted_gte(1))
    }
...
mod consume {
    ...
    pub fn scenario() -> Scenario {
        Scenario::new("consume")
            ...
            .step("test_cleanup", |a| a.deleted_gte(1))
    }
