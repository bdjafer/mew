...
mod edge_cases {
    ...
    pub fn scenario() -> Scenario {
        Scenario::new("edge_cases")
            ...
            .step("query_many_authors", |a| a.value(6))
            ...
            .step("query_overdue_by_time", |a| a.value(1))
            .step("spawn_member_borrows_three_simultaneously", |a| {
                a.created(7).linked(6)
            })
            .step("query_simultaneous_loans", |a| a.value(3))
            .step("spawn_book_without_copies", |a| a.created(1))
            .step("query_books_without_copies", |a| a.value(1))
            .step("create_copy_then_delete_book", |a| a.created(2).linked(1).deleted(1))
            .step("verify_orphaned_copy_remains", |a| a.value(1))
            .step("verify_copy_book_edge_removed", |a| a.value(0))
            .step("spawn_inactive_member_with_return_history", |a| {
                a.created(3).linked(2)
            })
            .step("query_inactive_members_with_history", |a| a.value(1))
    }
...
mod loan_management {
    ...
    pub fn scenario() -> Scenario {
        Scenario::new("loan_management")
            ...
            .step("verify_available_copies", |a| a.value(2))
            .step("borrow_copy", |a| a.linked(1).modified(1))
            .step("verify_copy_unavailable", |a| a.rows(1).contains_value(false))
            .step("query_active_loans", |a| a.value(1))
            .step("query_member_loans", |a| a.value(1))
            .step("return_copy", |a| a.unlinked(1).linked(1).modified(1))
            .step("verify_copy_available_again", |a| a.rows(1).contains_value(true))
            .step("query_no_active_loans", |a| a.value(0))
            .step("query_return_history", |a| a.value(1))
            .step("borrow_second_copy", |a| a.linked(1).modified(1))
            .step("query_borrowed_by_member2", |a| a.value(1))
            .step("verify_one_available_one_borrowed", |a| a.value(1))
    }
...
mod catalog_management {
    ...
    pub fn scenario() -> Scenario {
        Scenario::new("catalog_management")
            ...
            .step("count_authors_for_book", |a| a.value(2))
            .step("add_multiple_genres", |a| a.created(2).linked(2))
            .step("count_genres_for_book", |a| a.value(2))
            .step("add_multiple_copies_with_conditions", |a| a.created(4).linked(4))
            .step("count_all_copies", |a| a.value(4))
            .step("count_available_copies", |a| a.value(3))
            .step("query_by_condition", |a| a.value(1))
            .step("create_series_of_books", |a| a.created(2).linked(4))
            .step("count_books_by_author", |a| a.value(3))
            .step("count_books_in_genre", |a| a.value(3))
            .step("query_books_by_year_range", |a| a.value(3))
            .step("query_books_by_language", |a| a.value(1))
    }
...
mod member_management {
    ...
    pub fn scenario() -> Scenario {
        Scenario::new("member_management")
            ...
            .step("count_active_members", |a| a.value(2))
            .step("count_inactive_members", |a| a.value(1))
            .step("query_members_with_email", |a| a.value(2))
            .step("query_members_with_phone", |a| a.value(2))
            .step("setup_borrowing_history", |a| a.created(2).linked(2))
            .step("query_members_with_active_loans", |a| a.rows(1))
            .step("query_members_without_loans", |a| a.value(2))
            .step("deactivate_member", |a| a.modified(1))
            .step("verify_deactivation", |a| a.rows(1).contains_value(false))
            .step("update_member_info", |a| a.modified(1))
            .step("verify_member_update", |a| {
                a.rows(1)
                    .contains_value("alice.updated@example.com")
                    .contains_value("555-9999")
            })
            .step("query_by_name_partial", |a| a.value(2))
    }
...
mod query_complex {
    ...
    pub fn scenario() -> Scenario {
        Scenario::new("query_complex")
            ...
            .step("query_books_by_author", |a| a.value(2))
            .step("query_books_by_nationality", |a| a.value(2))
            ...
            .step("query_books_by_genre", |a| a.value(2))
            ...
            .step("query_recent_books", |a| a.value(2))
            .step("query_old_books", |a| a.value(1))
    }
